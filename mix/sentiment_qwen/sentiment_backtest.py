...
- HTML-отчёты в `mix/sentiment_qwen/plots`
- XLSX с результатами в `mix/sentiment_qwen/backtest`
"""
...
def main(
    ...
    rules_yaml: Path = typer.Option(
        None,
        "--rules-yaml",
        help="YAML-файл с правилами. По умолчанию mix/sentiment_qwen/rules.yaml.",
    ),
