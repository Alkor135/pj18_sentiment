"""
Бэктест sentiment-стратегии Gemma на основе `sentiment_scores.pkl`.
...
app = typer.Typer(help="Бэктест sentiment_gemma-стратегии по данным из PKL.")
...
def main(
    ...
    """Запускает полный бэктест sentiment_gemma и сохраняет отчёты."""
