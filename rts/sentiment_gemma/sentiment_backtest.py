...
Скрипт читает `rts/settings.yaml` (секции `common` и `sentiment_gemma`),
...
- HTML-отчёты в `rts/sentiment_gemma/plots`
- XLSX с результатами в `rts/sentiment_gemma/backtest`
"""
...
def main(
    ...
    # --- Загрузка настроек из rts/settings.yaml (common + sentiment_gemma) ---
