"""
Строит сырую групповую статистику по значениям sentiment для стратегии Gemma.
...
Результат выводится в консоль и сохраняется в XLSX в папку
`rts/sentiment_gemma/group_stats`.
"""
...
def resolve_sentiment_pkl(settings: dict) -> Path:
    """Возвращает абсолютный путь к PKL-файлу с sentiment-оценками Gemma."""
