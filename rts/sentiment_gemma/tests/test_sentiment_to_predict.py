...
from rts.sentiment_gemma.sentiment_to_predict import (
    load_settings,
    resolve_direction,
...
""".lstrip(),
    ...
    assert settings["predict_path"] == "C:/predict/rts_gemma"
    assert settings["sentiment_output_pkl"] == "rts/sentiment_gemma/sentiment_scores.pkl"
