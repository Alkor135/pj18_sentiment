...
from rts.sentiment_qwen.sentiment_to_predict import (
    load_settings,
    resolve_direction,
...
""".lstrip(),
    ...
    assert settings["predict_path"] == "C:/predict/rts_qwen"
    assert settings["sentiment_output_pkl"] == "rts/sentiment_qwen/sentiment_scores.pkl"
